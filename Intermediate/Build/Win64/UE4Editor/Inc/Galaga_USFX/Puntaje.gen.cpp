...
// End Cross Module References
...
#endif
#if WITH_METADATA
		static const UE4CodeGen_Private::FMetaDataPairParam NewProp_mallaPuntaje_MetaData[];
#endif
		static const UE4CodeGen_Private::FObjectPropertyParams NewProp_mallaPuntaje;
...
#endif
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UClass_APuntaje_Statics::NewProp_mallaPuntaje_MetaData[] = {
...
#endif
	const UE4CodeGen_Private::FObjectPropertyParams Z_Construct_UClass_APuntaje_Statics::NewProp_mallaPuntaje = { "mallaPuntaje", nullptr, (EPropertyFlags)0x00100000000a001d, UE4CodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(APuntaje, mallaPuntaje), Z_Construct_UClass_UStaticMeshComponent_NoRegister, METADATA_PARAMS(Z_Construct_UClass_APuntaje_Statics::NewProp_mallaPuntaje_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_APuntaje_Statics::NewProp_mallaPuntaje_MetaData)) };
	const UE4CodeGen_Private::FPropertyParamsBase* const Z_Construct_UClass_APuntaje_Statics::PropPointers[] = {
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_APuntaje_Statics::NewProp_mallaPuntaje,
	};
	...
	const UE4CodeGen_Private::FClassParams Z_Construct_UClass_APuntaje_Statics::ClassParams = {
		...
		DependentSingletons,
		nullptr,
		Z_Construct_UClass_APuntaje_Statics::PropPointers,
		nullptr,
		UE_ARRAY_COUNT(DependentSingletons),
		0,
		UE_ARRAY_COUNT(Z_Construct_UClass_APuntaje_Statics::PropPointers),
		0,
		0x009000A4u,
	...
	IMPLEMENT_CLASS(APuntaje, 3699015235);
