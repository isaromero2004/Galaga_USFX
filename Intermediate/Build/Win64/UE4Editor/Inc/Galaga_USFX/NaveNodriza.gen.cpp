...
// End Cross Module References
...
#endif
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UClass_ANaveNodriza_Statics::NewProp_NaveNodrizaMesh_MetaData[] = {
...
#endif
	const UE4CodeGen_Private::FObjectPropertyParams Z_Construct_UClass_ANaveNodriza_Statics::NewProp_NaveNodrizaMesh = { "NaveNodrizaMesh", nullptr, (EPropertyFlags)0x00100000000a001d, UE4CodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(ANaveNodriza, NaveNodrizaMesh), Z_Construct_UClass_UStaticMeshComponent_NoRegister, METADATA_PARAMS(Z_Construct_UClass_ANaveNodriza_Statics::NewProp_NaveNodrizaMesh_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_ANaveNodriza_Statics::NewProp_NaveNodrizaMesh_MetaData)) };
	const UE4CodeGen_Private::FPropertyParamsBase* const Z_Construct_UClass_ANaveNodriza_Statics::PropPointers[] = {
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_ANaveNodriza_Statics::NewProp_NaveNodrizaMesh,
	};
	...
	IMPLEMENT_CLASS(ANaveNodriza, 997715096);
